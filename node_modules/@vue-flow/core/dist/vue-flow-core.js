  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
        ...
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(getEdges), (edge, __, ___, _cached) => {
          const _memo = [edge.id];
          if (_cached && _cached.key === edge.id && vue.isMemoSame(_cached, _memo))
            return _cached;
          const _item = (vue.openBlock(), vue.createElementBlock("svg", {
            key: edge.id,
